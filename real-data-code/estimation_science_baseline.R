...
write.table(a_hat, sep=",",  col.names=FALSE, row.names=FALSE, file = 'alpha_science_2022_baseline.csv')
write.table(b_hat, sep=",",  col.names=FALSE, row.names=FALSE, file = 'beta_science_2022_baseline.csv')
write.table(mu_hat, sep=",",  col.names=FALSE, row.names=FALSE, file = 'mu_science_2022_baseline.csv')
write.table(sigma_hat, sep=",",  col.names=FALSE, row.names=FALSE, file = 'sigma_science_2022_baseline.csv')
write.table(post_hat, sep=",",  col.names=FALSE, row.names=FALSE, file = 'posterior_science_2022_baseline.csv')
