...
g_hat <- as.matrix(read.csv("gamma_reading_2022_d0.csv", header = F))
a_hat <- read.csv("alpha_reading_2022_d0.csv", header = F)[,1]
b_hat <- read.csv("beta_reading_2022_d0.csv", header = F)[,1]
mu_hat <- read.csv("mu_reading_2022_d0.csv", header = F)[,1]
sigma_hat <- read.csv("sigma_reading_2022_d0.csv", header = F)[,1]
...
output_a_matrix = cbind(1:61, trans_a_matrix[,1], 62:122,trans_a_matrix[,2], 123:183, trans_a_matrix[,3])
...
output_d_matrix = cbind(1:61, trans_d_matrix[,1], 62:122,trans_d_matrix[,2], 123:183, trans_d_matrix[,3])
...
J=dim(dat)[2]
p=dim(x)[2]
gam_val=read.csv('gamma_transformed_reading_2022_d0.csv', header=F)
gam_val=gam_val[,1]
...
mu_hat_0.05=read.csv( 'mu_reading_RMSD_2022_0.05.csv', header=F)[,1]
theta_ord_0.05=order(mu_hat_0.05, decreasing = T)
country_ord_0.05=country[theta_ord_0.05]
country_ord_0.05
sigma_hat_0.05=read.csv( 'sigma_reading_RMSD_2022_0.05.csv', header=F)[,1]
...
mu_hat_0.1=read.csv( 'mu_reading_RMSD_2022_0.1.csv', header=F)[,1]
sigma_hat_0.1=read.csv( 'sigma_reading_RMSD_2022_0.1.csv', header=F)[,1]
...
mu_hat_0.15=read.csv( 'mu_reading_RMSD_2022_0.15.csv', header=F)[,1]
sigma_hat_0.15=read.csv( 'sigma_reading_RMSD_2022_0.15.csv', header=F)[,1]
...
#### baseline
mu_hat_baseline=read.csv( 'mu_reading_2022_baseline.csv', header=F)[,1]
sigma_hat_baseline=read.csv( 'sigma_reading_2022_baseline.csv', header=F)[,1]
...
rotation_angle <- 120  # Change this to your desired rotation angle
