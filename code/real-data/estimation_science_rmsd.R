...
library("sirt")
source("functions_science_rmsd.R")
...
write.table(RMSD_mtx, sep=",",  col.names=FALSE, row.names=FALSE, file = 'RMSD_mtx_science_2022.csv')

#g_ini=matrix(0, J, p)
#a_ini= runif(J) #read.csv('alpha_raw_2PL_reading_mirtini_2022.csv', header=F)[,1]
#b_ini= runif(J)#read.csv('beta_raw_2PL_reading_mirtini_2022.csv', header=F)[,1]
#mu_ini= c(0, rnorm(p-1)) #read.csv('mu_raw_2PL_reading_mirtini_2022.csv', header=F)[,1]
#sigma_ini= runif(p) #read.csv('sigma_raw_2PL_reading_mirtini_2022.csv', header=F)[,1]
...
write.table(r$mu, sep=",",  col.names=FALSE, row.names=FALSE, file = paste0('mu_science_RMSD_2022_',RMSD_threshold,'.csv'))
write.table(r$sigma, sep=",",  col.names=FALSE, row.names=FALSE, file = paste0('sigma_science_RMSD_2022_',RMSD_threshold,'.csv'))
write.table(r$alpha.vec, sep=",",  col.names=FALSE, row.names=FALSE, file = paste0('a_science_RMSD_2022_',RMSD_threshold,'.csv'))
write.table(r$beta.vec, sep=",",  col.names=FALSE, row.names=FALSE, file = paste0('b_science_RMSD_2022_',RMSD_threshold,'.csv'))
write.table(r$gamma.vec, sep=",",  col.names=FALSE, row.names=FALSE, file = paste0('gamma_science_RMSD_2022_',RMSD_threshold,'.csv'))
write.table(r$post, sep=",",  col.names=FALSE, row.names=FALSE, file = paste0('post_science_RMSD_2022_',RMSD_threshold,'.csv'))
