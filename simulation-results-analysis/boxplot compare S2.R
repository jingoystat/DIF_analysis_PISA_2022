...
#         names=c("RMSD 0.05", "RMSD 0.10", "RMSD 0.15", "Baseline", "Proposed"), 
#         main="Setting 1 - N = 20000, J = 15, p = 10", ylim=c(0.2,1))


plot_data <- data.frame(
  Value = c(cor_all_N5000_r5_p10_J15_rmsd_0.05[,1],
            cor_all_N5000_r5_p10_J15_rmsd_0.1[,1],
            cor_all_N5000_r5_p10_J15_rmsd_0.15[,1],
            cor_all_N5000_r5_p10_J15_bcmk[,1],
            cor_all_N5000_r5_p10_J15[,1]),
  Method = rep(c("RMSD 0.05", "RMSD 0.10", "RMSD 0.15", "Baseline", "Proposed"),
              each = length(cor_all_N5000_r5_p10_J15_rmsd_0.05[,1]))
)
...
ggplot(plot_data, aes(x = Method, y = Value, fill = Method)) +
  geom_boxplot(width = 0.7, alpha = 0.8, outlier.size = 1, outlier.alpha = 0.3) +
  ...
  labs(title = "Setting 2 - N = 20000, J = 15, p = 10",
